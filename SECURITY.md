...
Vulnerabilities may be repored through the repository [issues](https://github.com/cm090/gradescope-autograder/issues) section. When the project is in active development, updates can be expected on a weekly basis at minimum. Higher risk vulnerabilities will receive top priority in the processing queue.
